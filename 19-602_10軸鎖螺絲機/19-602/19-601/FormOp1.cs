...
namespace _19_602
{
    public partial class FormOp1 : Form
    {
        ...
        private bool[] M1400 = new bool[15];//M1400 自動,原點,異常,螺絲不足,吹螺絲SOL
        ...
        private string[] LanguageChinese;
        private string[] LanguageJapan;
        ...
        private Button pbY0030, pbY0031, pbY0032, pbY0033, pbY0034, pbY0035, pbY0036, pbY0037,
        ...
        private void NewLabel()
        {
            ...
            lbX0046 = new Label(); lbX0047 = new Label();
            ...
            lbY0030 = new Label(); lbY0031 = new Label(); lbY0032 = new Label(); lbY0033 = new Label();
            ...
            pbY0030 = new Button(); pbY0031 = new Button(); pbY0032 = new Button(); pbY0033 = new Button();
        ...
        private void FormOp1_Load(object sender, EventArgs e)
        {
            ...
            {lbScrewStateAx1,lbScrewStateAx2,lbScrewStateAx3,lbScrewStateAx4,lbScrewStateAx5,lbScrewStateAx6,lbScrewStateAx7,lbScrewStateAx8,lbScrewStateAx9,lbScrewStateAx10 };
            ...
            tabControlManual.SelectedTab = tabPageM2;
        ...
        {
            string initFilename = @"D:\Resource\MachineInitialFile_19602.txt";
            string errFilename = @"D:\Resource\ErrorMessage_19602.txt";
            //初始檔
            try
            {
        ...
        private void _t1_Tick(object sender, EventArgs e)
        {
            ...
            Thread.Sleep(100);
            M1400 = PlcRead.ReadBool("M1400", 15).Content;//M1400 自動,原點,異常,螺絲不足,吹螺絲SOL
            Thread.Sleep(100);
            M1126 = PlcRead.ReadBool("M1126", 15).Content;//M1126設備設定
            Thread.Sleep(100);
            M1200 = PlcRead.ReadBool("M1200", 50).Content;//M1200鎖付狀態
            Thread.Sleep(100);
            M3000 = PlcRead.ReadBool("M3000", 146).Content;//異常
            Thread.Sleep(100);
        ...
        private void ReflashLampStatus()
        {
            ...
            if (M1126 != null && M1200 != null && R1000 != null && R1100 != null && M1400 != null && tabControlMain.SelectedTab == tabPageAuto)
            {
                ...
                if (M1126[13])
                {
                    lbJob_PAuto.Text = "NS4U";
                    pictureBox1.Image = _19_602.Properties.Resources.N4U;
                    lbScrewStateAx9.Visible = false;
                    lbScrewStateAx10.Visible = false;
                    lbTorqueAx9.Visible = false;
                    lbTorqueAx10.Visible = false;
                }
                if (M1126[14])
                {
                    lbJob_PAuto.Text = "NS6";
                    pictureBox1.Image = _19_602.Properties.Resources.N6;
                    lbScrewStateAx9.Visible = true;
                    lbScrewStateAx10.Visible = true;
                    lbTorqueAx9.Visible = true;
                    lbTorqueAx10.Visible = true;
                }
                //光柵
                if (M1126[10])
                {
            ...
            if (M1126 != null && M1200 != null && M1400 != null && tabControlMain.SelectedTab == tabPageManual)
            {
                ...
                if (M1126[13])
                {
                    lbJob_PManual.Text = "NS4U";
                }
                if (M1126[14])
                {
                    lbJob_PManual.Text = "NS6";
                }
                //光柵
                if (M1126[10])
                {
                ...
                if (tabControlManual.SelectedTab == tabPageTest)
                {
                    ...
                    if (X0[36])
                    {
                        lbX0044_M7.BackColor = Color.Lime;
                    }
                    else
                    {
                        lbX0044_M7.BackColor = Color.White;
                    }
                    //LS出
                    if (X0[5])
                    {
                    ...
                    if (X0[37])
                    {
                        lbX0045_M7.BackColor = Color.Orange;
                    }
                    else
                    {
                        lbX0045_M7.BackColor = Color.White;
                    }
                    //SOL & PB
                    if (Y0[0])
                    {
                    ...
                    if (Y0[21])
                    {
                        pbY0025_M7.BackColor = Color.Lime;
                        pbY0025_M7.ForeColor = Color.Black;
                    }
                    else
                    {
                        pbY0025_M7.BackColor = Color.Gray;
                        pbY0025_M7.ForeColor = Color.White;
                    }
                    if (Y0[22])
                    {
                        pbY0026_M7.BackColor = Color.Lime;
                        pbY0026_M7.ForeColor = Color.Black;
                    }
                    else
                    {
                        pbY0026_M7.BackColor = Color.Gray;
                        pbY0026_M7.ForeColor = Color.White;
                    }
                    if (Y0[23])
                    {
                        pbY0027_M7.BackColor = Color.Lime;
                        pbY0027_M7.ForeColor = Color.Black;
                    }
                    else
                    {
                        pbY0027_M7.BackColor = Color.Gray;
                        pbY0027_M7.ForeColor = Color.White;
                    }
                }
                #endregion
            }
            #endregion
            #region --設定頁--
            if (R2000 != null && tabControlMain.SelectedTab == tabPageSetting)
            {
                //Feed screw time
                int iv = R2000[15];
                double dv = iv;
                ...
                if (M1126[13])
                {
                    pbNs4Select.BackColor = Color.Lime;
                    pbNs4Select.ForeColor = Color.Black;
                    pbNs6Select.BackColor = Color.Gray;
                    pbNs6Select.ForeColor = Color.White;
                }
                if (M1126[14])
                {
                    pbNs4Select.BackColor = Color.Gray;
                    pbNs4Select.ForeColor = Color.White;
                    pbNs6Select.BackColor = Color.Lime;
                    pbNs6Select.ForeColor = Color.Black;
                }
                //光柵
                if (M1126[10])
                {
            ...
            if (tabControlMain.SelectedTab == tabPageError)
            {
                if (M1126[12])
                {
            ...
            #endregion
            #region --BZ頁--
            if (tabControlMain.SelectedTab == tabPageStopBZ)
            {
                if (M1126[8])
                {
        ...
        //定位頂出
        private void pbY0003_Click(object sender, EventArgs e)
        {
        ...
        //移位出
        private void pbY0005_Click(object sender, EventArgs e)
        {
        ...
        #region --沒用--
        //下
        private void pbY0033_MouseUp(object sender, MouseEventArgs e)
        {
        }
        private void pbY0033_MouseDown(object sender, MouseEventArgs e)
        {
        }
        //上下
        private void pbY0030_MouseUp(object sender, MouseEventArgs e)
        {
        }
        private void pbY0030_MouseDown(object sender, MouseEventArgs e)
        {
        }
        #endregion
        #region --BZ--
        ...
        #region --產品選擇--
        //NS4
        private void pbNs4Select_Click(object sender, EventArgs e)
        {
            PlcWrite.writeToPLC("M1139", true);
            Thread.Sleep(100);
            PlcWrite.writeToPLC("M1140", false);
        }
        //NS6
        private void pbNs6Select_Click(object sender, EventArgs e)
        {
            PlcWrite.writeToPLC("M1139", false);
            Thread.Sleep(100);
            PlcWrite.writeToPLC("M1140", true);
        }
        #endregion
        #region--language--
        ...
        private void getDriverData()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                string s1 = (i + 1).ToString();
                s1 = s1.PadLeft(2, '0');
                p.ID = s1;
                myLog.LogText = System.Text.ASCIIEncoding.ASCII.GetString(p.SendByte);
                Driver.sendToDriver(p);
                int j = 0;
                while (!(Driver.dataReceiveFinishFlag || Driver.dataReceiveTimeoutFlag || j >= 10000))
                {
                    j++;
                }
                if (Driver.dataReceiveTimeoutFlag || j >= 10000)
                {
            ...
            foreach (var x in _data.TorqueValue)
            {
                ...
                if (x.Contains("07D"))
                {
                    ...
                    try
                    {
                        double d = double.Parse(s);
                        d = d / 1000;
                        lbTorqueValue[6].Text = string.Format("{0:#.###NM}", d);
                    }
                    catch (Exception ex)
                    {
                        myLog.LogText = ex.ToString();
                ...
                if (x.Contains("08D"))
                {
                    ...
                    try
                    {
                        double d = double.Parse(s);
                        d = d / 1000;
                        lbTorqueValue[7].Text = string.Format("{0:#.###NM}", d);
                    }
                    catch (Exception ex)
                    {
                        myLog.LogText = ex.ToString();
                ...
                if (x.Contains("09D"))
                {
                    ...
                    try
                    {
                        double d = double.Parse(s);
                        d = d / 1000;
                        lbTorqueValue[8].Text = string.Format("{0:#.###NM}", d);
                    }
                    catch (Exception ex)
                    {
                        myLog.LogText = ex.ToString();
                ...
                if (x.Contains("10D"))
                {
                    ...
                    try
                    {
                        double d = double.Parse(s);
                        d = d / 1000;
                        lbTorqueValue[9].Text = string.Format("{0:#.###NM}", d);
                    }
                    catch (Exception ex)
                    {
                        myLog.LogText = ex.ToString();
        ...
        //變更顯示文字
        private void ToLoadLanguage()
        {
            //讀出檔案
            XLWorkbook wb = new XLWorkbook(@"D:\Resource\Language_19602.xlsx");
            var ws = wb.Worksheet(1);
            int lastCount = ws.LastRowUsed().RowNumber();
            //放入字串陣列
            LanguageChinese = new string[lastCount];
            LanguageJapan = new string[lastCount];
            for (int i = 0; i < lastCount; i++)
            {
                LanguageChinese[i] = (string)ws.Cell(i + 1, 1).Value;
                LanguageJapan[i] = (string)ws.Cell(i + 1, 2).Value;
            }
        }
        private void ChangeLanguage()
        {
            ...
            {
                case 0:
                    LanguageString = LanguageChinese;
                    break;
                case 1:
                    LanguageString = LanguageJapan;
                    break;
                default:
                    break;
            }
            ...
            label20.Text = LanguageString[129];
            label27.Text = LanguageString[106];
            //手動
            ...
            label6.Text = LanguageString[129];
            label29.Text = LanguageString[106];
            //設定
            label2.Text = LanguageString[5];
            label3.Text = LanguageString[97];
            label12.Text = LanguageString[103];
            label25.Text = LanguageString[129];
            label15.Text = LanguageString[106];
            ...
            lbY0003.Text = LanguageString[119];
            pbY0003.Text= LanguageString[119];
            lbY0004.Text = LanguageString[14];
            pbY0004.Text = LanguageString[14];
            lbY0005.Text = LanguageString[15];
            pbY0005.Text = LanguageString[15];
            lbY0006.Text = LanguageString[120];
            pbY0006.Text = LanguageString[120];
            lbY0007.Text = LanguageString[121];
            pbY0007.Text = LanguageString[121];
            lbY0010.Text = LanguageString[16];
            pbY0010.Text = LanguageString[16];
            lbY0011.Text = LanguageString[17];
            pbY0011.Text = LanguageString[17];
            lbY0012.Text = LanguageString[10];
            pbY0012.Text = LanguageString[10];
            lbY0013.Text = LanguageString[11];
            pbY0013.Text = LanguageString[11];
            lbY0014.Text = LanguageString[122];
            pbY0014.Text = LanguageString[122];
            lbY0015.Text = LanguageString[123];
            pbY0015.Text = LanguageString[123];
            lbY0016.Text = LanguageString[12];
            pbY0016.Text = LanguageString[12];
            lbY0017.Text = LanguageString[13];
            pbY0017.Text = LanguageString[13];
            lbY0020.Text = LanguageString[124];
            pbY0020.Text = LanguageString[124];
            lbY0021.Text = LanguageString[125];
            pbY0021.Text = LanguageString[125];
            lbY0022.Text = LanguageString[126];
            pbY0022.Text = LanguageString[126];
            lbY0023.Text = LanguageString[127];
            pbY0023.Text = LanguageString[127];
            lbY0024.Text = LanguageString[128];
            pbY0024.Text = LanguageString[128];
            lbY0025.Text = LanguageString[20];
            pbY0025.Text = LanguageString[20];
            pbY0025_M7.Text = LanguageString[20];
            lbY0026.Text = LanguageString[29];
            pbY0026.Text = LanguageString[29];
            pbY0026_M7.Text = LanguageString[29];
            lbY0027.Text = LanguageString[21];
            pbY0027.Text = LanguageString[21];
            pbY0027_M7.Text = LanguageString[21];
